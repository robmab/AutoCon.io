...
if (isset($_REQUEST["usuario"])) {
    if (isset($_REQUEST["comprar"])) {
        $sql =
            "UPDATE componente_usuario SET finalizado='Si' WHERE usuario='" .
            $_REQUEST["usuario"] .
            "' AND componente='" .
            $_REQUEST["componente"] .
            "'";
    ...
    if (isset($_REQUEST["cancelar"])) {
        $sql =
            "DELETE FROM componente_usuario WHERE usuario='" .
            $_REQUEST["usuario"] .
            "' AND componente='" .
            $_REQUEST["componente"] .
            "' AND n='" .
...
for ($cont2 = 0; $cont < $num; $cont2++) {
    ...
    if ($mem && $mem->num_rows > 0) {
        ...
        $datosGComponentes[$cont]["idU"] = $info["usuario"];
        $componente = $info["componente"];
        $datosGComponentes[$cont]["idC"] = $info["componente"];
