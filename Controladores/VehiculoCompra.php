...
if (isset($_SESSION["user"])) {
    ...
    $_SESSION["mensajeBD"] =
        "Tienes que registrarte antes de poder comprar o alquilar un vehículo.";
...
if (isset($_REQUEST["comprar"])) {
    ...
    $sql =
        "SELECT * FROM vehiculos WHERE modelo='" . $_SESSION["ModeloVeh"] . "'";
    $memi = $conexion->query($sql);
    if ($memi->num_rows > 0) {
        $info = $memi->fetch_array();
        $vehiculo = $info["id"];
    ...
    $sql =
        "INSERT INTO vehiculos_usuarios(usuario,vehiculo,reservado,alquilado,precio,n)   VALUES('" .
        $usuario .
        "','" .
        $vehiculo .
        "','Si','No','" .
        $_SESSION["listaVeh"][$_SESSION["ModeloVeh"]]["precioRebajado"] .
        "','" .
        $n .
        "')";
    ...
    if ($conexion->affected_rows > 0) {
        ...
        $_SESSION["mensajeBD"] =
            "Tu vehículo se ha reservado correctamente. Pasate por la tienda mas cercana para terminar el pago y llevarte tu coche.";
        header("Location:../Vistas/Index.php");
        exit();
    } else {
        $_SESSION["mensajeBD"] =
            "No puedes reservar un coche que ya has reservado o alquilado.";
        header("Location:../Vistas/Index.php");
        exit();
    }
    ...
    $sql =
        ...
        $vehiculo .
        "','No','Si','" .
        $_SESSION["listaVeh"][$_SESSION["ModeloVeh"]]["precioAlquiler"] .
        "','" .
        $n .
        "')";
    $comprobar = $conexion->query($sql);
    ...
    if ($conexion->affected_rows > 0) {
        ...
        $_SESSION["mensajeBD"] =
            "Pásate cuando quieras por tienda para recoger tu vehículo y empezar a usarlo.";
        header("Location:../Vistas/Index.php");
        exit();
    } else {
