...
if ( $mem&&$mem->num_rows>0 ) {
    ...
    $usuario =   $info['usuario'];    $datosGVehiculos[$cont]['idU']=  $info['usuario']  ;
    $vehiculo =  $info['vehiculo'];   $datosGVehiculos[$cont]['idV']=  $info['vehiculo']  ;
    ...
    $memi=$conexion->query($sql) ;
     ...
     $rebaja=$info['rebaja'];
      ...
      $rebaja = $rebaja /100; $rebaja = $rebaja -1; $rebaja = $rebaja * -1;
...
header("Location:../Vistas/GVehiculosVista.php");exit;
