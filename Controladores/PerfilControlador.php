...
if (isset($_REQUEST["edicion"])) {
    if (isset($_SESSION["email"]) && $_SESSION["email"] != "") {
        ...
        $sql =
            "SELECT correo FROM usuarios WHERE nombreUsuario='" .
            $_SESSION["user"] .
            "'  ";
    ...
    if (isset($_SESSION["nombreUs"]) && $_SESSION["nombreUs"] != "") {
        ...
        if ($_SESSION["user"] == $nombreUs) {
            ...
            $_SESSION["mensajeBD"] =
                "El usuario " . $nombreUs . " ya existe, prueba con otro.";
            header("Location:../Vistas/PerfilVista.php?editar=1");
            exit();
        }
    }
    ...
    if (isset($_SESSION["nif"]) && $_SESSION["nif"] != "") {
        ...
        $sql =
            "SELECT nif FROM usuarios WHERE nombreUsuario='" .
            $_SESSION["user"] .
            "'  ";
        $memi = $conexion->query($sql);
        if ($memi->num_rows > 0) {
    ...
    if (isset($_SESSION["fechaNac"]) && $_SESSION["fechaNac"] != "") {
        ...
        $sql =
            "UPDATE usuarios SET fechaNacimiento='" .
            $fechaNac .
            "' WHERE nombreusuario='" .
            $_SESSION["user"] .
            "' OR correo='" .
    ...
    if (isset($_SESSION["codigoP"]) && $_SESSION["codigoP"] != "") {
        ...
        $sql =
            "UPDATE usuarios SET codigoPostal='" .
            $codigoP .
            "' WHERE nombreusuario='" .
            $_SESSION["user"] .
            "' OR correo='" .
    ...
    if (isset($_SESSION["movil"]) && $_SESSION["movil"] != "") {
        ...
        $sql =
            "UPDATE usuarios SET numeroMovil='" .
            $movil .
            "' WHERE nombreusuario='" .
            $_SESSION["user"] .
            "' OR correo='" .
    ...
    if (
        isset($_SESSION["contraseñaActual"]) &&
        $_SESSION["contraseñaActual"] != ""
    ) {
        ...
        if (
            isset($_SESSION["contraseñaNueva"]) &&
            $_SESSION["contraseñaNueva"] != ""
        ) {
            if (
                isset($_SESSION["contraseñaNueva2"]) &&
                $_SESSION["contraseñaNueva2"] != ""
            ) {
...
$datosUsu["fechaNacimiento"] = date(
    "d-m-Y",
    strtotime($datosUsu["fechaNacimiento"])
);
