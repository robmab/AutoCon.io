...
if (isset($_REQUEST["añadir"])) {
    ...
    $sql =
        "INSERT INTO eventos_descuentos(nombre,fecha_in,fecha_fin,porciento,banner)   VALUES('" .
        $nombre .
        "','" .
        $_REQUEST["fechaI"] .
        "','" .
    ...
    if ($conexion->affected_rows > 0) {
        ...
        $_SESSION["mensajeBD"] =
            "No puedes crear un evento durante las mismas fechas que otro que tengas creado.";
        header("Location:../Vistas/EventosVista.php#1");
        exit();
    }
}
...
if (isset($_REQUEST["editar"])) {
    $sql =
        "UPDATE eventos_descuentos SET banner='" .
        $_REQUEST["banner"] .
        "' WHERE  fecha_in='" .
        $_REQUEST["fi"] .
        "'   AND fecha_fin='" .
...
if (isset($_REQUEST["eliminar"])) {
    $sql =
        "DELETE FROM eventos_descuentos WHERE fecha_in='" .
        $_REQUEST["fi"] .
        "'   AND fecha_fin='" .
        $_REQUEST["ff"] .
        "' ";
