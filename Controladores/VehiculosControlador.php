...
if ( $mem&&$mem->num_rows>0 ) {
    $info= $mem->fetch_array() ;
       ...
       $rebajaM= $info['rebaja']/100  ; $rebajaM= $rebajaM - 1  ; $rebajaM = $rebajaM * -1 ;
...
if ( $mem&&$mem->num_rows>0 ) {
    $info2= $mem->fetch_array() ;
     ...
     if($info2['fecha_fin'] >= $fechaActual){    
         ...
         $multiplicador= $listaVeh[$info['modelo']]['rebaja'] /100 ; $multiplicador= $multiplicador - 1 ; $multiplicador= $multiplicador * -1 ;
