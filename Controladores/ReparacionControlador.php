...
function solicitar_servicio()
{
    ...
    $sql =
        "SELECT *  FROM reparacion WHERE  servicio='" .
        $valor .
        "' AND aceptado='Si' AND usuario='" .
        $user .
        "' ";
    ...
    if ($mem && $mem->num_rows > 0) {
        $_SESSION["mensajeBD"] =
            "No puedes solicitar un servicio que ya está en espera de completarse.";
    ...
    $sql =
        "SELECT *  FROM reparacion WHERE  servicio='" .
        $valor .
        "' AND aceptado='Espera' AND usuario='" .
        $user .
        "' ";
    ...
    $sql =
        "SELECT *  FROM reparacion WHERE fecha='" .
        $fechaActual .
        "' AND servicio='" .
        $valor .
        "' AND aceptado!='Finalizado' AND usuario='" .
        $user .
        "' ";
    ...
    if ($mem && $mem->num_rows > 0) {
        $_SESSION["mensajeBD"] =
            "No puedes solicitar el mismo servicio en el mismo día.";
        ...
        $sql =
            "INSERT INTO reparacion(usuario,servicio,aceptado,n)   VALUES('" .
            $user .
            "','" .
            $valor .
            "','Espera','" .
        ...
        if ($conexion->affected_rows > 0) {
            $_SESSION["mensajeBD"] =
                "Gracias por solicitar nuestros servicios. Puedes ver el seguimiento en tu perfil.";
            header("Location:../Vistas/ReparacionVista.php");
            exit();
        }
    }
