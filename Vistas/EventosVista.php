            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <!-- Contact Form Area -->
                    ...
                    <div class="contact-form">
                        ...
                        <center><h3>Gestionar Eventos de Descuento</h3></center><br><br>
                        <!-- Datos -->
                   ...
                   <?php  foreach ($_SESSION['datosEventos'] as  $num){  
                       ...
                       ?> 
                            ...
                            <tr><td><?php echo $num['nombre'] ?></td>
                            <td><?php echo $num['fechaI'] ?></td>
                            <td><?php echo $num['fechaF'] ?></td>
                            <td><?php echo $num['porciento'] . " %" ?></td>
                            
                            
           <form method="post" action="../Controladores/EventosControlador.php?editar=1&fi=<?php echo $num['fechaII'] ?>&ff=<?php echo $num['fechaFF'] ?>#1">

                            
                            <td><input name="banner" type="text" style="width:400px;height:30px" required="" value="<?php echo $num['banner'] ?>"/></td>
                            
                            
                        
                            <td><button type="submit" class="btn ">Editar</button></td>
                             </form>  
                            <td><a href="../Controladores/EventosControlador.php?eliminar=1&fi=<?php echo $num['fechaII'] ?>&ff=<?php echo $num['fechaFF'] ?>#1" style="color: red">Cancelar</a></td>    </tr>
                        ...
                        <tr>
                            ...
                            <tr> 
                              <form method="post" action="../Controladores/EventosControlador.php?añadir=1#1">
                                ...
                                <td><center><button type="submit" class="btn ">Añadir</button></center></td>
                                <td></td>
