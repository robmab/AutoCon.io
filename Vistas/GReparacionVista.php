                ...
                <div class="row justify-content-center" id="1">
                    ...
                    <div class="contact-form">
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach (
                                    $_SESSION["datosGReparacion"]
                                    as $num
                                ) {
                                    if ($num["aceptado"] != "Finalizado") { ?> 
                                <tr>
                                    <td><img height="200%" width="200%" src="../img/reparacion/<?php if (
                                        $num["servicio"] == "sustituir"
                                    ) {
                                        echo "1.jpg";
                                    ...
                                    <td><?php if (
                                        ...
                                        <?php if (
                                            $num["servicio"] == "bateria"
                                        ) {
                                            echo "Baterías y Arranque";
                                        } ?>
                                        <?php if (
                                            $num["servicio"] == "bombilla"
                                        ) {
                                            echo "Bombillas";
                                        } ?>
                                        <?php if (
                                    ...
                                    <td>
                                        ...
                                        <form method="post" action="../Controladores/GReparacionControlador.php?editar=1&n=<?php echo $num[
                                            "n"
                                        ]; ?>#1">
                                            <input style="width:100px;height:30px" name="precioE" type="number" required step="0.01" value="<?php echo $num[
                                                "precio"
                                            ]; ?>"    />
                                            <?php if (
                                                isset($_SESSION["rebaja"])
                                            ) { ?>
                                            <p style="color: red"><?php echo $_SESSION[
                                                "rebaja"
                                            ] . "% D.</p>";} ?>
                                    ...
                                    <td>
                                        ...
                                        <form method="post" action="../Controladores/GReparacionControlador.php?aceptar=1&n=<?php echo $num[
                                            "n"
                                        ]; ?>#1"  >
                                        ...
                                        <center> <a href="../Controladores/GReparacionControlador.php?finalizar=1&n=<?php echo $num[
                                            "n"
                                        ]; ?>#1" style="color: palegoldenrod " > &ltFinalizar&gt</a></center>
                                        <?php } ?>
                                    </td>
                                    <td><?php if (
                                        $num["aceptado"] != "Finalizado"
                                    ) { ?>
                                        <a href="../Controladores/GReparacionControlador.php?cancelar=1&n=<?php echo $num[
                                            "n"
                                        ]; ?>#1" style="color:red">Cancelar</a><?php } ?>
                                    </td>
                                </tr>
                                <?php }
                                } ?>  
