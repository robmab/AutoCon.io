...
<body>
   ...
   ?>
    ...
    <div class="world-catagory-area mt-50" id="1">
        ...
        <div class="container">
                        <center> <h1>Servicios</h1><br></center>
...
<center>  <?php   if (isset($_SESSION['mensajeBD'])){
    ?> <br><br>  <?php
                ...
                <!-- ========== Single Blog Post ========== -->     
                                                        ...
                                                        <div class="col-12 ">
                                            <!-- Single Blog Post -->
                                            <div  class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.1s">
                                                <!-- Post Thumbnail -->
                                            ...
                                            <!-- Single Blog Post -->
                                            <div id="2" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.2s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                            ...
                                            <!-- Single Blog Post -->
                                            <div id="3" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                            ...
                                            <!-- Single Blog Post -->
                                            <div id="4" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                ...
                                                <div class="post-content">
                                                   ...
                                                   <a href="../Controladores/ReparacionControlador.php?valor=aceite#1" class="button turquoise"><span>➣</span>Aceite y Líquidos</a>
                                                                                        ...
                                                                                        <!-- Single Blog Post -->
                                            <div id="5" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                ...
                                                <div class="post-content">
                                                   ...
                                                   <a href="../Controladores/ReparacionControlador.php?valor=pintura#1" class="button turquoise"><span>➣</span>Renovación de pinturas y arañazos</a>
                                                                                                                                    ...
                                                                                                                                    <!-- Single Blog Post -->
                                            <div id="6" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                ...
                                                <div class="post-content">
                                                 ...
                                                 <div id="7" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                ...
                                                <div class="post-content">
                                                   ...
                                                   <a href="../Controladores/ReparacionControlador.php?valor=bateria#1" class="button turquoise"><span>➣</span>Baterías y arranque</a>
                                                         ...
                                                         <div id="8" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                              ...
                              <div id="9" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                            ...
                            <div id="10" class="single-blog-post2 post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.3s">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
