                    ...
                    unset($_SESSION['mensajeBD']);
                        ...
                        <form action="../Controladores/ValidarNumero.php" method="post" onsubmit="return dobValidate('dn')">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                  <a style="color: #6c757d"  ><font size="2px">  Email </font></a>
  ...
  if (letra!=let) {
     ...
     return false;
                                       ...
                                       <div class="group">
                                           ...
                                           <input style="color: #6c757d" type="date" name="fechaNac" id="fechaNac" required autocomplete="off">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                       ...
                       <div class="col-12 col-md-6"> 
                                     ...
                                     <div class="group">
                                         ...
                                         <select style="color: #6c757d; font-size: 14px" name="provincia" id="provincia" >
