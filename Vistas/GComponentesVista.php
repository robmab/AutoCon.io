            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <!-- Contact Form Area -->
                    ...
                    <div class="contact-form">
                        ...
                        <center><h3 >Componentes comprados</h3></center><br><br>
                        <!-- Datos -->
                   ...
                   <?php  foreach ($_SESSION['datosGComponentes'] as  $num){  ?> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $num['nombreC']." - " .$num['tipo'] ?></td>
                                <td><?php echo "x".$num['cantidad']; ?></td>
                               ...
                               <td><?php if($num['finalizado']!="Si"){ ?>
                                   
                                   <a href="../Controladores/GComponentesControlador.php?comprar=1&usuario=<?php echo $num['idU'] ?>&componente=<?php echo $num['idC']?>#1" style="color: <?php if ($num['finalizado']=="No"){?>#E1B42B     <?php }else{ ?>deeppink   <?php  } ?>  " > &ltPasar a comprado&gt</a>
                                   
                                   <?php }  ?></td>
                               
                               
                                <td><?php if($num['finalizado']!="Si"){ ?><a href="../Controladores/GComponentesControlador.php?cancelar=1&usuario=<?php echo $num['idU'] ?>&componente=<?php echo $num['idC']?>&n=<?php echo $num['n'] ?>#1" style="color:red">Cancelar</a><?php }  ?></td>
