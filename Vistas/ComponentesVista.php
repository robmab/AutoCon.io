...
<html lang="en">
    ...
    <body>
        ...
        <center>
            ...
            <?php if (isset($_SESSION["mensajeBD"])) { ?> <br><br>  <?php
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post post-style-3 mt-50 wow fadeInUpBig" data-wow-delay="0.2s">
                    ...
                    <div class="post-thumbnail">
                        <img src="../img/componentes/<?php echo $listaComponentes[
                            $nombre
                        ][$tipo]["ruta"]; ?>" alt="">
                        <!-- Post Content -->
                        <div class="post-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="post-meta">
                                <form action="../Controladores/ComponentesControlador.php?comprar=1&nombre=<?php echo $nombre; ?>#1"  method="post">
                                    ...
                                    foreach (
                                        $listaComponentes[$nombre]
                                        as $tipo => $num
                                    ) { ?>
                                    <h6 style="color: white">
                                        <?php
                                        if (
                                            $listaComponentes[$nombre][$tipo][
                                                "cantidad"
                                            ] > 0
                                        ) { ?>
                                        <input    type=radio name='tipo' value="<?php echo $tipo; ?>-<?php echo $listaComponentes[
    $nombre
][$tipo]["precioR"]; ?>"> <?php $conta = 2;}
                                        echo $tipo;
                                        ?>       
                                        <?php if (
                                            $listaComponentes[$nombre][$tipo][
                                        ...
                                        por <i style="color: #3399ff; font-size: 18px; text-shadow: 0.1em 0.1em #000000"><?php echo $listaComponentes[
                                            $nombre
                                        ][$tipo][
                                            "precio"
                                        ]; ?> €</i> <?php } else { ?>
                                        por  <strike> <?php echo $listaComponentes[
                                            $nombre
                                        ][$tipo][
                                            "precioO"
                                        ]; ?> €       </strike> 
                                        <i  style="color: red; font-size: 22px;text-shadow: 0.1em 0.1em #000000"><?php echo $listaComponentes[
                                            $nombre
                                        ][$tipo][
                                            "precioR"
                                        ]; ?> €</i>  <?php } ?>
                                    ...
                                    <div class="col-12">
                                        <center> <?php if (
                                            $conta == 2
                                        ) { ?>     <button type="submit" name="submit" value="Submit" class="btn world-btn" >Comprar</button><?php } ?></center>
                                    </div>
                                </form>
                            </div>
                        </div>
