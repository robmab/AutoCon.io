            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <!-- Contact Form Area -->
                    ...
                    <div class="contact-form">
                        ...
                        <center><h3>Usuarios Registrados</h3></center><br><br>
                        <!-- Datos -->
                   ...
                   <?php  foreach ($_SESSION['datosUsuarios'] as $nombreUsuario => $num){  ?> 
                            ...
                            <tr>
                                ...
                                <td><a href="../Controladores/UsuariosControlador.php?id=<?php echo $num['id'] ?>&nU=<?php echo $nombreUsuario  ?>&eliminar=1#1" style="color:red">Eliminar</a></td>
